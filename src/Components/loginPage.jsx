            ...
            <div className="min-h-screen bg-slate-200 flex items-center justify-center p-4 sm:p-6 lg:p-8">
                ...
                <div className="w-full max-w-md bg-slate-800/80 backdrop-blur-xl border border-slate-700/60 rounded-2xl shadow-2xl p-6 sm:p-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-bold tracking-tight text-white">ParkEase</h1>
                        <p className="text-sm text-slate-400 mt-1">Smart parking made effortless</p>
                    </div>

                    {/* Error Alert */}
                    {error && (
                        <div className="mb-5 p-3 rounded-lg bg-rose-500/10 border border-rose-500/30 text-rose-400 text-xs font-medium">
                            {error}
                        </div>
                    )}
                        ...
                        <div className="flex items-center justify-between text-xs pt-1">
                            <label className="flex items-center gap-2 text-slate-400 hover:text-slate-300 cursor-pointer select-none">
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="w-4 h-4 rounded border-slate-700 bg-slate-900/50 text-blue-600 focus:ring-blue-500/20 accent-blue-600 cursor-pointer"
                                />
                                Remember me
                            </label>
                            <a href="#forgot-password" className="font-medium text-blue-400 hover:text-blue-300 transition hover:underline">
                                Forgot password?
                            </a>
                        </div>
                    ...
                    <div className="mt-8 pt-5 border-t border-slate-700/50 text-center">
                        <p className="text-xs text-slate-400">
                            ...
                            <a href="/signup" className="font-semibold text-blue-400 hover:text-blue-300 transition hover:underline">
                                Create one
                            </a>
                        </p>
                    </div>
